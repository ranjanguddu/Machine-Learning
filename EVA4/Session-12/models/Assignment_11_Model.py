...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr  9 21:56:15 2020
...
class Net(nn.Module):
    ...
    def __init__(self, in_planes=3, planes=64, stride=1):
        ...
        # ==================This is Prep Blosck============================
        self.conv1 = nn.Conv2d(in_planes, planes, kernel_size=3, stride=stride, padding=1, bias=False) # 32x32x64  # 64x64x64
        self.bn1 = nn.BatchNorm2d(planes)

        # =================This is LAYER - 1 ======================== 
        in_planes= 64
        planes = 128
        self.conv2 = nn.Conv2d(in_planes, planes, kernel_size=3, stride=stride, padding=1, bias=False) # 32x32x128  # 64x64x128
        self.maxpool1 = nn.MaxPool2d(2,2) # 16x16x128 # 32x32x128
        self.bn2 = nn.BatchNorm2d(planes) #16x16x128 # 32x32x128

        # ================Residue Block of layer - 1 =================
        in_planes = 128
        planes = 128
        self.Rconv1 = nn.Conv2d(in_planes, planes, kernel_size=3, stride=stride, padding=1, bias=False) # 16x16x128 # 32x32x128
        self.Rbn1 = nn.BatchNorm2d(planes)

        self.Rconv2 = nn.Conv2d(in_planes, planes, kernel_size=3, stride=stride, padding=1, bias=False) # 16x16x128 # 32x32x128
